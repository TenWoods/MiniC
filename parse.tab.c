...
static const yytype_uint8 yyrline[] =
{
      ...
      65,    68,    69,    71,    75,    76,    79,    80,    83,    86,
      89,    90,    93,    94,    95,    96,    97,    98,   101,   102,
...
/* Line 1455 of yacc.c  */
#line 69 "parse.y"
    {(yyval.ptr)=mknode(ID,(yyvsp[(3) - (4)].ptr),NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,(yyvsp[(1) - (4)].type_id));;}
    break;
